  ...
  export default {
    ...
    methods: {
      ...
      getParams () {
        ...
        // console.log('itemtitle:' + this.itemTitle)
      },
      // 取消选择
      ...
      // 获取对应事项审核已通过的证书
      async getAbsenceStudentList () {
        var that = this
        this.$http.get('/allPassedCertificatesByItemId', {
          params: {
            page: this.page,
            itemId: this.itemId
          } })
          .then(function (response) {
            if (response.status === 200) {
              ...
              that.absenceStudentList = response.data.content
